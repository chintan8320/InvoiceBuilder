...
export const metadata: Metadata = {
    title: "InvoiceBuilder | Free Invoice Generator",
    description:
        "Create invoices effortlessly with InvoiceBuilder, the free invoice generator. Try it now!",
