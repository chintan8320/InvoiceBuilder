...
InvoiceBuilder is a web-based invoice generator application built with Next.js 13, TypeScript, React, and the Shadcn UI library. It provides an easy way to create and manage professional invoices.
...
Follow these instructions to get InvoiceBuilder up and running on your local machine.
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/al1abb/InvoiceBuilder.git
   cd InvoiceBuilder
   ```
